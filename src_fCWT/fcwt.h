...
namespace fcwt {
    ...
    void cwt(float *input, int inputsize, float *output, int pstoctave, int pendoctave, int pnbvoice, float c0, int nthreads, bool use_optimalization_schemes); // added by Misha
    void create_optimization_schemes(int maxsize, int threads, int flags); // added by Misha
